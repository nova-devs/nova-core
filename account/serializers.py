...
from account import models, actions
from account.utils import get_user, get_user_login
...
class MyTokenObtainPairSerializer(TokenObtainPairSerializer):
    ...
    def get_token(cls, user):
        ...
        token['user'] = get_user(user)

        return token

    def validate(self, attrs):
        try:
            attrs['username'] = actions.decrypt_string(self.initial_data.get("username"))
            attrs['password'] = actions.decrypt_string(self.initial_data.get("password"))
